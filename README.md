# Block Video Player — 統合版(Bedrock)ブロック動画プレイヤー (v2.0.0)
...
**最新バージョン v2.0.0**: 任意カラー動画の複数搭載、10秒単位OGG音声トラック同期再生、コンパス等のリモコンアイテムによるゲーム内GUI操作、ウルトラ全110色ブロックパレット、5種ディザリングアルゴリズム選択に対応！
